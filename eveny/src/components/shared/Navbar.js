    ...
    <nav className="NavContainer p-4 h-48 BGcolor w-full">
      ...
      <div className="NavTop mx-auto  mb-2 flex justify-between">
        ...
        <div className="flex flex-col ">
          ...
          <h4 className="text-center font-bold tracking-tight text-transparent bg-clip-text bg-gradient-to-b from-[#6C21A7] to-[#DB2777]">Eveny</h4>
        </div>

        {/* Avatar */}
        
        <div className="NavAvatar w-12 h-12 rounded-full overflow-hidden noSelect"  onClick={handleAvatarClick} onBlur={handleAvatarClick}>
